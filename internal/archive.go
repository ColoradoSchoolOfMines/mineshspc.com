...
var archiveInfo = []templates.YearInfo{
	{
		...
		Links: []templates.Link{
			{URL: "/static/2025-solutions.pdf", Title: "Solution Sketch Slides"},
			{URL: "https://open.kattis.com/problem-sources/CS%40Mines%20High%20School%20Programming%20Competition%202025", Title: "Problems"},
		},
		Results: []templates.CompetitionResult{
			{
				...
				Teams: []templates.WinningTeam{
					{Place: "1st", Name: "Fairview High School", School: "Fairview High School", Location: "Boulder"},
					{Place: "2nd", Name: "Mohakos Koders", School: "Niwot High School", Location: "Longmont"},
					{Place: "3nd", Name: "Lobos 3", School: "Rocky Mountain High School", Location: "Fort Collins"},
				},
			},
			{
				...
				Shortname: "FirstTime",
				Teams: []templates.WinningTeam{
					{Place: "1st", Name: "Importing Iguanas", School: "Niwot High School", Location: "Longmont"},
					{Place: "2nd", Name: "Name Deleted", School: "Innovation Center SVVSD", Location: "Longmont"},
					{Place: "3nd", Name: "Runtime Terror", School: "George Washington High School", Location: "Denver"},
				},
			},
		},
	},
	{
		...
		Links: []templates.Link{
			...
			{URL: "https://open.kattis.com/problem-sources/CS%40Mines%20High%20School%20Programming%20Competition%202024", Title: "Problems"},
		},
		Results: []templates.CompetitionResult{
			{
				Name:      "Overall Winners",
	...
	},
	{
		...
		Links: []templates.Link{
			...
			{URL: "https://open.kattis.com/problem-sources/CS%40Mines%20High%20School%20Programming%20Competition%202023", Title: "Problems"},
		},
		Results: []templates.CompetitionResult{
			{
	...
	},
	{
		...
		Links: []templates.Link{
			...
			{URL: "https://open.kattis.com/problem-sources/CS%40Mines%20High%20School%20Programming%20Competition%202022", Title: "Problems"},
		},
		Results: []templates.CompetitionResult{
			{
				Name: "Advanced",
	...
	},
	{
		...
		Links: []templates.Link{
			...
			{URL: "https://open.kattis.com/problem-sources/CS%40Mines%20High%20School%20Programming%20Competition%202021", Title: "Problems"},
		},
		Results: []templates.CompetitionResult{
			{
				Teams: []templates.WinningTeam{
	...
	},
	{
		...
		Links: []templates.Link{
			...
			{URL: "https://open.kattis.com/problem-sources/CS%40Mines%20High%20School%20Programming%20Competition%202020", Title: "Problems"},
		},
		Results: []templates.CompetitionResult{
			{
				Teams: []templates.WinningTeam{
	...
	},
	{
		...
		Links: []templates.Link{
			...
			{URL: "https://open.kattis.com/problem-sources/CS%40Mines%20High%20School%20Programming%20Competition%202019", Title: "Problems"},
		},
		Results: []templates.CompetitionResult{
			{
				Teams: []templates.WinningTeam{
	...
	},
	{
		...
		Links: []templates.Link{
			{URL: "https://open.kattis.com/problem-sources/CS%40Mines%20High%20School%20Programming%20Competition%202018", Title: "Problems"},
		},
		Results: []templates.CompetitionResult{
			{
				Teams: []templates.WinningTeam{
...
func (a *Application) GetArchiveTemplate(*http.Request) map[string]any {
	// Convert templates.Link to the map format expected by HTML templates.
	// Use local anonymous types to avoid polluting the package namespace.
	type htmlLink struct {
		URL   string
		Title string
	}
	type htmlWinningTeam struct {
		Place    string
		Name     string
		School   string
		Location string
	}
	type htmlCompetitionResult struct {
		Name      string
		Shortname string
		Teams     []htmlWinningTeam
	}
	type htmlYearInfo struct {
		Year            int
		RecapParagraphs []string
		Links           []htmlLink
		Results         []htmlCompetitionResult
	}

	years := make([]htmlYearInfo, len(archiveInfo))
	for i, y := range archiveInfo {
		links := make([]htmlLink, len(y.Links))
		for j, l := range y.Links {
			links[j] = htmlLink{URL: string(l.URL), Title: l.Title}
		}
		results := make([]htmlCompetitionResult, len(y.Results))
		for j, r := range y.Results {
			teams := make([]htmlWinningTeam, len(r.Teams))
			for k, t := range r.Teams {
				teams[k] = htmlWinningTeam{Place: t.Place, Name: t.Name, School: t.School, Location: t.Location}
			}
			results[j] = htmlCompetitionResult{Name: r.Name, Shortname: r.Shortname, Teams: teams}
		}
		years[i] = htmlYearInfo{
			Year:            y.Year,
			RecapParagraphs: y.RecapParagraphs,
			Links:           links,
			Results:         results,
		}
	}
